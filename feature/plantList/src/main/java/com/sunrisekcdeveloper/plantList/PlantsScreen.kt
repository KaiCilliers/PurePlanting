...
fun PlantsScreen(
    ...
    Column {
        ...
        waterWorkerState?.let { workInfos ->
            workInfos.forEach {
                Text(text = it)
            }
        }
